      ...
      {},
        {
            Chinese: '一',
            English: 'MON',
            classList: ['自@语', [ '语', '语',''], ['数','数',''],[ '英', '英',''], ['物','物',''], ['劳','劳',''],[ '生', '生',''],[ '政', '政',''], '班', '自@英'],
            timetable: 'MonWed'
        },
        {
            Chinese: '二',
            English: 'TUE',
            classList: ['自@语',[ '语', '语','数'],[ '英', '英','英'], ['数','数','语'],[ '地', '地','生'], ['体','体','体'], ['史','史','史'],['物','物','物'], '自', '自@语'],
            timetable: 'MonWed'
        },
        {
            Chinese: '三',
            English: 'WED',
            classList: ['自@英', [ '英', '英','英'], [ '语', '语','语'], ['物','物','物'], ['数','数','数'], ['音','音','音'], [ '地', '地','地'], ['体','体','体'], '自',  '自@数'],
            timetable: 'MonWed'
        },
        {
            Chinese: '四',
            English: 'THR',
            classList: ['自@数', ['数','数','数'], [ '语', '语','信'], [ '英', '英','英'], ['美','美','生'],[ '信', '信','语'], [ '生', '生','美'], ['体','体','体'], '自',  '自@物'],
            timetable: 'Thu'
        },
        {
            Chinese: '五',
            English: 'FRI',
            classList: [['自@英','自@英','自@英'],[ '语', '语','语'],['数','数','数'], ['史','史','史'],[ '英', '英','英'], [ '政', '政','政'], ['物','物','物'], ['习','心','习'], ['社','社','自'],'自'],
            timetable: 'Fri'
        },
       {
            Chinese: '六',
            English: 'SAT',
            classList: [['','','自@英'],[ '', '','语'],['','','数'], ['','','史'],[ '', '','英'], [ '', '','政'], ['','','物'], ['','','心'], ['','','自'],'自'],
            timetable: 'MonWed'
        },
